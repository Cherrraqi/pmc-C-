Pour le code Classifier-based-on-Scikitlearn
il faut utiliser :
mytrain.csv (comme base d apprentissage)
mytest.csv (comme base de test)

-----------------------------------------------------------
pour le pmc en C ++
base d apprentissage : train.txt
base de test :test.txt
...
Pour le pmc en python vous pouvez l ' utliser sur mnist database
car je l'ai deja tester sur cette base de chiffre manuscrit
